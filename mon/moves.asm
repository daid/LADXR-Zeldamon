...
movesTable:
    ...
    move i"Psybeam",      CONFUSION_SIDE_EFFECT,       65, PSYCHIC_TYPE, 100, 20
    ...
    move i"Confusion",    CONFUSION_SIDE_EFFECT,       50, PSYCHIC_TYPE, 100, 25
    move i"Psychic m",    SPECIAL_DOWN_SIDE_EFFECT,    90, PSYCHIC_TYPE, 100, 10
    move i"Hypnosis",     SLEEP_EFFECT,                 0, PSYCHIC_TYPE,  60, 20
    move i"Meditate",     ATTACK_UP1_EFFECT,            0, PSYCHIC_TYPE, 100, 40
    move i"Agility",      SPEED_UP2_EFFECT,             0, PSYCHIC_TYPE, 100, 30
    move i"Quick attack", NO_ADDITIONAL_EFFECT,        40, NORMAL,       100, 30
    move i"Rage",         RAGE_EFFECT,                 20, NORMAL,       100, 20
    move i"Teleport",     SWITCH_AND_TELEPORT_EFFECT,   0, PSYCHIC_TYPE, 100, 20
    ...
    move i"Barrier",      DEFENSE_UP2_EFFECT,           0, PSYCHIC_TYPE, 100, 30
    move i"Light screen", LIGHT_SCREEN_EFFECT,          0, PSYCHIC_TYPE, 100, 30
    move i"Haze",         HAZE_EFFECT,                  0, ICE,          100, 30
    move i"Reflect",      REFLECT_EFFECT,               0, PSYCHIC_TYPE, 100, 20
    ...
    move i"Amnesia",      SPECIAL_UP2_EFFECT,           0, PSYCHIC_TYPE, 100, 20
    move i"Kinesis",      ACCURACY_DOWN1_EFFECT,        0, PSYCHIC_TYPE,  80, 15
    ...
    move i"Dream eater",  DREAM_EATER_EFFECT,         100, PSYCHIC_TYPE, 100, 15
    ...
    move i"Psywave",      SPECIAL_DAMAGE_EFFECT,        1, PSYCHIC_TYPE,  80, 15
    ...
    move i"Rest",         HEAL_EFFECT,                  0, PSYCHIC_TYPE, 100, 10
